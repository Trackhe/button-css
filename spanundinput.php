...
<html>
	...
	<!-- Button -->
	<button class="rot">Button (Button)</button>
	</br></br>
	
	<!-- Span Button -->
	<span class="btn rot">Button (Span)</span>
	</br></br>
	...
	<input class="rot" type="submit" value="Button (submit)">
	</br></br>
	<!-- Input type="button" Button -->
    <button class="rot" type="button" id="test3">Button (Button with type)</button>
	</br></br>
	...
	<button class="dunkelblau">Button</button>
